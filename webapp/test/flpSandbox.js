		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#projectsaptraining-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectsaptraining-display": {
								"semanticObject": "projectsaptraining",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectsaptraining",
									"url": sap.ui.require.toUrl("projectsaptraining")
								}
							}
						}
					}
